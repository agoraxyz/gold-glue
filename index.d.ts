...
* @returns {Promise<any>}
*/
export function getAuctionWasm(auction_id: string): Promise<any>;
/**
* @param {boolean} secondary
* @returns {Promise<any>}
*/
export function getAuctionsWasm(secondary: boolean): Promise<any>;
/**
* @param {Pubkey} root_state_pubkey
* @param {BigInt} cycle_num
* @returns {Promise<any>}
*/
export function getAuctionCycleWasm(root_state_pubkey: Pubkey, cycle_num: BigInt): Promise<any>;
/**
* @param {string} auction_id
* @returns {Promise<boolean>}
*/
export function auctionExistsWasm(auction_id: string): Promise<boolean>;
/**
* @param {any} args
* @returns {Promise<any>}
*/
export function claimFundsWasm(args: any): Promise<any>;
/**
* @param {any} args
* @returns {Promise<any>}
*/
export function initializeAuctionWasm(args: any): Promise<any>;
/**
* @param {any} args
* @returns {Promise<any>}
*/
export function placeBidWasm(args: any): Promise<any>;
/**
* @param {any} args
* @returns {Promise<any>}
*/
export function claimRewardsWasm(args: any): Promise<any>;
/**
* @param {any} args
* @returns {Promise<any>}
*/
export function modifyAuctionWasm(args: any): Promise<any>;
/**
* @param {any} args
* @returns {Promise<any>}
*/
export function deleteAuctionWasm(args: any): Promise<any>;
/**
