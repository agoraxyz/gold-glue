...
export function getAuctionsWasm(a: number): number;
export function getAuctionCycleWasm(a: number, b: number, c: number): number;
export function auctionExistsWasm(a: number, b: number): number;
export function claimFundsWasm(a: number): number;
export function initializeAuctionWasm(a: number): number;
export function placeBidWasm(a: number): number;
export function claimRewardsWasm(a: number): number;
export function modifyAuctionWasm(a: number): number;
export function deleteAuctionWasm(a: number): number;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hfc7d0612ad9584c2(a: number, b: number, c: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function __wbindgen_free(a: number, b: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__ha352847e1b85caf6(a: number, b: number, c: number, d: number): void;
